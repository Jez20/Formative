<%
    ...
    {
       if(session.getAttribute("roles") == "Admin")
       {
       ...
       <div class="flex flex-col md:flex-row">
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <div>
                ...
                <input type="text"
                  ...
                  placeholder="Name" name="txt_username" required/>
              </div>
              <div>
                ...
                <input
                  class="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                  placeholder="Password" type="password" name="txt_password" required/>
              </div>
            <div class="wrapper">
            ...
            <div>
                ...
                <input
                  class="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                  placeholder="Enter Captcha" name="LoginForm" required/>
            </div>
              <button
                class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue"
                href="#" type="submit" name="btn_login" value="Login" style="background-color:#FF4B2B">
                Log In
              </button>
              <div class="mt-4 text-center">
                <p class="text-sm">Don't have an account yet? <a href="signup.jsp"
                    class="text-blue-600 hover:underline" style="color: #FF4B2B"> Sign Up.</a></p>
                    <p style="color:green">
                    <%
          ...
          <div class="h-32 md:h-auto md:w-1/2">
            <img class="object-cover w-full h-full" src="https://pbs.twimg.com/media/D0ef8qqUYAIlMBa?format=jpg&name=medium"
              alt="img" />
          </div>
        </div>
      </div>
