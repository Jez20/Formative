...
<html>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      ...
      <a class="nav-link" href="#">List of Employees</a>
          ...
          <li class="nav-item">
      <a class="nav-link" href="#">Edit Records</a>
    </li>
      <li class="nav-item">
      <a class="nav-link" href="#">Delete Records</a>
      </li>
  </ul>
  ...
  <ul class="nav navbar-nav ml-auto">
        <li class="nav navbar-nav navbar-right">
            <a class="nav-link disabled" style="color: rgba(255,255,255,.5) !important">Welcome Back <%=session.getAttribute("login")%> !</a>
        </li>
        <li class="nav navbar-nav navbar-right">
